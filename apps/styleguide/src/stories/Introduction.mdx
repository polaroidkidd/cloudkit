...
<p>
	This is a styleguide for the cloudkit.dle.dev project. It is a collection of components and patterns
	that can be used to build the cloudkit.dle.dev website. It is built using Svelte and Storybook.
</p>
